...
Start-Process -FilePath "powershell" -ArgumentList "-NoExit","-Command","cd c:\Users\user\Documents\PersonalProject\disease_outbreak_prediction\App\outbreakiq; $env:VITE_API_BASE_URL='http://localhost:8000/api/v1'; npm run dev"